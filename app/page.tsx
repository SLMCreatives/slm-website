        ...
        <div className="flex gap-6 justify-left items-center">
          ...
          <div className="text-left z-10 px-12 lg:w-1/2 left-0 text-balance space-y-8">
            <motion.h1
              ...
              className="py-8 -my-8 text-5xl font-extrabold tracking-tight lg:text-7xl bg-clip-text text-transparent bg-gradient-to-br from-emerald-600 to-emerald-900 "
            >
            ...
            >
              Creating professional unique experiences for brands that matter. I
              am here to help you solve your marketing problems and allow you to
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              <motion.button
                ...
                className="bg-gradient-to-br from-emerald-600 text-sm to-emerald-900 opacity-90 hover:opacity-100 hover:from-emerald-900 hover:to-emerald-600 text-white font-medium rounded-lg px-5 py-3 shadow-lg cursor-pointer"
              >
                Marketing Solutions
              </motion.button>
              <motion.a
                ...
                transition={{ duration: 0.5, delay: 2 }}
                href="/form"
                className="bg-transparent cursor-pointer ring-1 ring-emerald-700  text-emerald-700 hover:ring-2 font-medium text-sm rounded-lg px-5 py-3 shadow-lg text-center"
              >
                Get Free Quotation
              </motion.a>
            </div>
