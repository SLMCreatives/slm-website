...
const options = [
  ...
  {
    name: "AI Tools",
    desc: "AI tools for content creation, analytics and more.",
  },
];
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center text-balance">
              <h1 className="py-8 -my-8 text-6xl font-extrabold tracking-tight lg:text-7xl bg-clip-text text-transparent bg-gradient-to-br from-emerald-600 to-emerald-900">
                Modern Website Development & Design
              </h1>
              <p className="mt-6 text-xl leading-8 text-gray-600">
                ...
                for corporate businessess and successful brands.
              </p>
            </div>
        ...
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
          <div className="flex flex-col justify-center divide-y divide-slate-200 [&>*]:py-16">
            <div className="w-full max-w-3xl mx-auto">
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                This is the general process of building a website
              </p>
              <div className="my-6">
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-emerald-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                    ...
                    <div className="text-xl font-bold text-slate-900">
                      Set project goals and targets
                    </div>
                  </div>
                  <div className="text-slate-500">
                    Set a clear and measurable goals and targets that would be
                    benificial to your company.
                  </div>
                </div>
