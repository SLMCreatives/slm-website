        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl text-left">
            ...
            <p className="mt-4 max-w-lg text-white sm:text-xl/relaxed">
              Learn all the important things about video editing and elevate
              your editing skills with the latest tools and techniques.
            </p>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold sm:text-4xl">
              "I finally understand all the different jargon that video editors
              use! I can finally tell them exactly what I want!"
            </h2>
          </div>
            ...
            <div className="lg:py-16">
              <article className="space-y-4 text-gray-600">
                <p>
                  ...
                  Doloremque, quidem. Necessitatibus, quidem?
                </p>
...
*/}
      ...
      <section>
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 mx-auto">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center justify-center lg:gap-x-16">
