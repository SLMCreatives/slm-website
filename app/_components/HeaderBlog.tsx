    ...
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-col  ">
          <p className="text-3xl text-balance font-bold text-slate-900 text-center">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6 gap-2">
                ...
                <ul className="mt-4 flex justify-left gap-6 md:gap-8">
                  <li>
                    <a
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/slm.creatives/"
                      rel="noreferrer"
                      target="_blank"
                      className="text-gray-700 transition hover:text-gray-700/75"
                    >
                  ...
                  <li>
                    <a
                      href="https://github.com/SLMCreatives"
                      rel="noreferrer"
                      target="_blank"
                      className="text-gray-700 transition hover:text-gray-700/75"
                    >
